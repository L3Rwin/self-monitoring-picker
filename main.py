...
def main(opts):
    ...
    if opts.test_submission:
        ...
        test_env = ('val_unseen', (R2RPanoBatch(opts, feature, img_spec, batch_size=opts.batch_size,
                                 splits=['val_unseen'], tokenizer=tok), Evaluation(['val_unseen'], opts)))
        agent_kwargs = {
            'opts': opts,
            'env': test_env[1][0],
            'results_path': "",
    ...
    save_checkpoint({
        ...
        'optimizer': optimizer.state_dict(),
        'max_episode_len': opts.max_episode_len,
    }, 1, checkpoint_dir=opts.checkpoint_dir, name="FINAL")
